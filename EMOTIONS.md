...
| 5 | 温柔 | 软笑垂眉，轻声细语 | 咧嘴 0.35、眉微垂 −0.1、眼 0.9 |
...
### 5. 温柔
- **设计**：最轻最软的笑——咧嘴 0.35（浅笑）+ 眼 0.9（不瞪不闭）+ **眉微微垂 −0.1**（下垂眉显柔），歪头 Z3。脸红参数实测不可见，所以温柔不靠脸红，靠"垂眉 + 浅笑"组合。
- **配方**：`ParamMouthForm 0.35, ParamEyeLOpen/ROpen 0.9, ParamBrowLY/RY -0.1, ParamAngleZ 3`
