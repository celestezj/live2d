...
| 5 | 温柔 | 软笑垂眉，双颊泛红双腿微并，含羞待放 | 咧嘴 0.35、脸红 1.0、夹腿 −6、垂睫 0.85、眼珠微垂 −0.2、低头 −3 |
| 6 | 关切 | 轻蹙垂睫，侧头倾听凑近 | 眉轻蹙 −0.3/0.3、垂睫眼 0.7、眼珠朝你 0.3、嘴角微压 |
| 7 | 好奇 | 大歪头打量，眼珠转 | 歪头 Z9、眼珠 0.3/0.1、眉挑 |
| 8 | 期待 | 星星眼 + 眼巴巴抬头 | 星星眼 Param9、头垂 Y−5、歪头 Z2、眉挑 |
| 9 | 无奈 | 一眉挑一眉垂，撇嘴角 | 眉 0.3/−0.2、Shrug 0.5、歪头 Z5、髋摆 Z−2 |
...
- **设计**（v2 定稿：含羞待放）：最轻最软的笑 + 一点含羞——
  ...
  - **腿**：Param28 −6（双腿**稍微并拢**，大腿缝 22px→10px，小腿/脚锚定不动）。
  - **头**：歪头 Z3 + **微低头 AngleY −3**（低头含羞，但比沮丧 −7 轻得多）。
- **配方**：`ParamMouthForm 0.35, ParamEyeLOpen/ROpen 0.85, ParamBrowLY/RY -0.1, ParamAngleZ 3, Param13 1.0, Param28 -6, ParamEyeBallY -0.2, ParamAngleY -3`
...
### 7. 好奇
- **设计**：**大幅度歪头 Z9**（打量）+ 眼珠转动向上偏 0.3/0.1 + 眉一挑一平 0.2/0.05 + 嘴微张 0.15（好奇得有点想说话）。
- **配方**：`ParamAngleZ 9, ParamEyeBallX 0.3, ParamEyeBallY 0.1, ParamBrowLY 0.2, ParamBrowRY 0.05, ParamMouthOpenY 0.15, ParamMouthForm 0.1, ParamEyeLOpen/ROpen 0.95`
...
### 9. 无奈
- **设计**：**一眉挑 0.3、一眉垂 −0.2**（不对称的"随便啦"）+ **嘴角 Shrug 0.5**（撇嘴角）+ 歪头 Z5 + 髋摆 BodyAngleZ −2。鼓脸参数实测不可见，去掉。
- **配方**：`ParamBrowLY 0.3, ParamBrowRY -0.2, ParamEyeLOpen/ROpen 0.85, ParamMouthForm 0.1, ParamAngleZ 5, ParamBodyAngleZ -2, Param61 0.5`
